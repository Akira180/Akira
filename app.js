...
const jeopardyCategories = [
    {
        ...
        questions: [
            ...
            {
                question: 'Who desinged the first car?',
                answers: ['Karl Benz', 'Hennry FOrd'],
                correct: 'Karl Benz',
                level: 'Hard',
            },
        ],
    },
    {
        ...
        questions: [
            {
                question: 'Where is the Buckingham Palace?',
                answers: ['Richmond', 'London'],
                correct: 'London',
                level: 'easy',
            },
            {
                question: 'Where is the Colossum',
                answers: ['Rome', 'Milan'],
                correct: 'Rome',
                level: 'medium',
            },
            {
                question: 'Where is Mount Killamonjaro',
...
function addCategory(category) {
   ...
   const genreTitle = documnet.createElement('div')
